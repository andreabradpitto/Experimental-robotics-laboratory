...
Here is a picture the robotic dog (again, taken from Gazebo):
...
This will start the simulation on both Gazebo and RViz, and also open a window showing the robotic dog camera's output.
