...
def planning(goal):
    ...
    feedback = assignment3.msg.PlanningFeedback()
    result = assignment3.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer(
        'reaching_goal_topic', assignment3.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
